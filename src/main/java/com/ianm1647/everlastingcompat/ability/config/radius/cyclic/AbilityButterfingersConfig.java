package com.ianm1647.everlastingcompat.ability.config.radius.cyclic;
...
public class AbilityButterfingersConfig extends AbilityConfig<AbilityTypePotionEffectRadius> {
    ...
    public AbilityButterfingersConfig() {
        super("butterfingers", (eConfig) -> new AbilityTypePotionEffectRadius(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                PotionEffectRegistry.BUTTERFINGERS.get()) {
