...
public class AbilitySpellDamageConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilitySpellDamageConfig() {
        super("spell_damage", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
