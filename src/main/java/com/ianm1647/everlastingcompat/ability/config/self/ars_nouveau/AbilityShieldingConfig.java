package com.ianm1647.everlastingcompat.ability.config.self.ars_nouveau;
...
public class AbilityShieldingConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityShieldingConfig() {
        super("shielding", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
