package com.ianm1647.everlastingcompat.ability.config.radius.upgrade_aquatic;
...
public class AbilityVibingConfig extends AbilityConfig<AbilityTypePotionEffectRadius> {
    ...
    public AbilityVibingConfig() {
        super("vibing", (eConfig) -> new AbilityTypePotionEffectRadius(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
