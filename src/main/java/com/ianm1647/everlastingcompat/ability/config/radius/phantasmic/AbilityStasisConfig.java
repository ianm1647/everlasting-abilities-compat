package com.ianm1647.everlastingcompat.ability.config.radius.phantasmic;
...
public class AbilityStasisConfig extends AbilityConfig<AbilityTypePotionEffectRadius> {
    ...
    public AbilityStasisConfig() {
        super("stasis", (eConfig) -> new AbilityTypePotionEffectRadius(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                NourishedNetherModMobEffects.STASIS.get()));
    }
