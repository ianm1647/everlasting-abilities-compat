...
public class AbilityAttackRangeConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityAttackRangeConfig() {
        super("attack_range", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                PotionEffectRegistry.ATTACK_RANGE.get()));
    }
