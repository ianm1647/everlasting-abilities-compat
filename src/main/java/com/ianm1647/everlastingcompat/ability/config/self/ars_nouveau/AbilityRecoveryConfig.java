...
public class AbilityRecoveryConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityRecoveryConfig() {
        super("recovery", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                ModPotions.RECOVERY_EFFECT.get()));
    }
