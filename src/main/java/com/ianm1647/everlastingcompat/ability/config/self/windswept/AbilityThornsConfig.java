package com.ianm1647.everlastingcompat.ability.config.self.windswept;
...
public class AbilityThornsConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityThornsConfig() {
        super("thorns", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
