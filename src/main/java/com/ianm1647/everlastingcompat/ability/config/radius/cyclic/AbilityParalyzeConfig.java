...
public class AbilityParalyzeConfig extends AbilityConfig<AbilityTypePotionEffectRadius> {
    ...
    public AbilityParalyzeConfig() {
        super("paralyze", (eConfig) -> new AbilityTypePotionEffectRadius(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
