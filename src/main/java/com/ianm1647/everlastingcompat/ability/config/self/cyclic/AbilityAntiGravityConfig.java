...
public class AbilityAntiGravityConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityAntiGravityConfig() {
        super("anti_gravity", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                PotionEffectRegistry.ANTIGRAVITY.get()));
    }
