package com.ianm1647.everlastingcompat.ability.config.radius.ars_nouveau;
...
public class AbilityFreezingConfig extends AbilityConfig<AbilityTypePotionEffectRadius> {
    ...
    public AbilityFreezingConfig() {
        super("freezing", (eConfig) -> new AbilityTypePotionEffectRadius(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
