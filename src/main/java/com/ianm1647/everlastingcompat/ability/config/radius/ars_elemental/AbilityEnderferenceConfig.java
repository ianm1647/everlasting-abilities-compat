...
public class AbilityEnderferenceConfig extends AbilityConfig<AbilityTypePotionEffectRadius> {
    ...
    public AbilityEnderferenceConfig() {
        super("enderference", (eConfig) -> new AbilityTypePotionEffectRadius(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
