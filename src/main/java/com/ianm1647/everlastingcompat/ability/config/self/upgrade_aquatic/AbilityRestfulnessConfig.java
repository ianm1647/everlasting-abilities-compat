...
public class AbilityRestfulnessConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityRestfulnessConfig() {
        super("restfulness", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
