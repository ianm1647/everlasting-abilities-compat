...
public class AbilitySwimSpeedConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilitySwimSpeedConfig() {
        super("swim_speed", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                PotionEffectRegistry.SWIMSPEED.get()));
    }
