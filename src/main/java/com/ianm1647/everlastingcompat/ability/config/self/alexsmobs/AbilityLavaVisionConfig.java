...
public class AbilityLavaVisionConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityLavaVisionConfig() {
        super("lava_vision", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                AMEffectRegistry.LAVA_VISION.get()));
    }
