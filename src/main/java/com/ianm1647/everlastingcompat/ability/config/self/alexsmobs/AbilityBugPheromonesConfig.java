...
public class AbilityBugPheromonesConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityBugPheromonesConfig() {
        super("bug_pheromones", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                AMEffectRegistry.BUG_PHEROMONES.get()));
    }
