...
public class AbilityRepellenceConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityRepellenceConfig() {
        super("repellence", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
