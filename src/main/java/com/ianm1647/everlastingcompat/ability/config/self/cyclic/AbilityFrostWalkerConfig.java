...
public class AbilityFrostWalkerConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityFrostWalkerConfig() {
        super("frost_walker", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                PotionEffectRegistry.FROST_WALKER.get()));
    }
