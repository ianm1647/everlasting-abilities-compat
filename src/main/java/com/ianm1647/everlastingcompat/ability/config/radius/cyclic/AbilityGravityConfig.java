...
public class AbilityGravityConfig extends AbilityConfig<AbilityTypePotionEffectRadius> {
    ...
    public AbilityGravityConfig() {
        super("gravity", (eConfig) -> new AbilityTypePotionEffectRadius(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                PotionEffectRegistry.GRAVITY.get()) {
