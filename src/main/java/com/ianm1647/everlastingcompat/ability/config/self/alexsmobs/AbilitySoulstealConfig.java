...
public class AbilitySoulstealConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilitySoulstealConfig() {
        super("soulsteal", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                AMEffectRegistry.SOULSTEAL.get()));
    }
