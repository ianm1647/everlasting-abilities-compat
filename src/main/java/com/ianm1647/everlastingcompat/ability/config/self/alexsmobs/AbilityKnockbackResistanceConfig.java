...
public class AbilityKnockbackResistanceConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityKnockbackResistanceConfig() {
        super("knockback_resistance", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                AMEffectRegistry.KNOCKBACK_RESISTANCE.get()));
    }
