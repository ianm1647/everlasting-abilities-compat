...
public class AbilityMagnetismConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityMagnetismConfig() {
        super("magnetism", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                PotionEffectRegistry.MAGNETIC.get()));
    }
