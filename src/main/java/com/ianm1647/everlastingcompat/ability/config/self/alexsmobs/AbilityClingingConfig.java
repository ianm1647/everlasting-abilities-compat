...
public class AbilityClingingConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityClingingConfig() {
        super("clinging", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
