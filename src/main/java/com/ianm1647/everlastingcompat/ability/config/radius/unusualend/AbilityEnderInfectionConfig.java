package com.ianm1647.everlastingcompat.ability.config.radius.unusualend;

import net.mcreator.nourishednether.init.NourishedNetherModMobEffects;
...
public class AbilityEnderInfectionConfig extends AbilityConfig<AbilityTypePotionEffectRadius> {
    ...
    public AbilityEnderInfectionConfig() {
        super("ender_infection", (eConfig) -> new AbilityTypePotionEffectRadius(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                UnusualendModMobEffects.ENDER_INFECTION.get()));
    }
