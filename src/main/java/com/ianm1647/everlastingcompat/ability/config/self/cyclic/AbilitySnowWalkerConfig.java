...
public class AbilitySnowWalkerConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilitySnowWalkerConfig() {
        super("snow_walker", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                PotionEffectRegistry.SNOWWALK.get()));
    }
