...
public class AbilityWaterwalkingConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityWaterwalkingConfig() {
        super("waterwalking", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                PotionEffectRegistry.WATERWALK.get()));
    }
