package com.ianm1647.everlastingcompat.ability.config.self.cyclic;
...
public class AbilityReachDistanceConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityReachDistanceConfig() {
        super("reach_distance", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
                ...
                () -> obtainableOnCraft,
                () -> obtainableOnLoot,
                PotionEffectRegistry.REACH_DISTANCE.get()));
    }
