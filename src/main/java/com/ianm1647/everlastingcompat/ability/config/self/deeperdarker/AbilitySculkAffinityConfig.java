package com.ianm1647.everlastingcompat.ability.config.self.deeperdarker;
...
public class AbilitySculkAffinityConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilitySculkAffinityConfig() {
        super("sculk_affinity", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
