package com.ianm1647.everlastingcompat.ability.config.self.infernalexp;
...
public class AbilityLuminanceConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityLuminanceConfig() {
        super("luminance", (eConfig) -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(),
                () -> rarity,
                () -> maxLevel,
                () -> xpPerLevel,
